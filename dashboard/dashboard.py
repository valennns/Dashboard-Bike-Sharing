...
with st.expander("📅 Tren Penyewaan Sepeda Harian"):
...
# Analisis Musiman
with st.expander("🌤️ Pengaruh Musim terhadap Penyewaan Sepeda"):
...
# Analisis Cuaca
with st.expander("🌦️ Pengaruh Cuaca terhadap Penyewaan Sepeda"):
...
with st.expander("📈 Korelasi Faktor Cuaca terhadap Penyewaan Sepeda"):
    fig, ax = plt.subplots(figsize=(8, 5))
