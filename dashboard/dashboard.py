...
holiday_demand = day_df.groupby('holiday')['cnt'].sum()
workingday_demand = day_df.groupby('workingday')['cnt'].sum()
fig, axes = plt.subplots(1, 2,1, figsize=(12, 5))
...
for i, feature in enumerate(weather_features):
    sns.scatterplot(data=day_df, x=feature, y='cnt', ax=axes[i], color='#29B5DA')
...
for i, feature in enumerate(weather_features):
    ...
    sns.scatterplot(data=day_df, x=feature, y='registered', ax=axes[i], label='Registered Users', color='#29B5DA')
